...
void Option::render() {
    ...
    if (optionEntries[3][0].entry != NULL) {
        apply_surface((SCREEN_WIDTH - optionEntries[3][0].entry->w) / 2,
                ((SCREEN_HEIGHT - optionEntries[3][0].entry->h) / 2) + (SCREEN_WIDTH / float(32)),
                optionEntries[3][0].entry, screen);
    }
